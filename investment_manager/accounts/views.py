...
# InvestmentAccountViewSet to manage investment accounts
class InvestmentAccountViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        # Restrict users to only their accounts
...
class TransactionViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        # Automatically set the user and account when creating a transaction
...
# AdminTransactionViewSet to allow admin access to all transactions
class AdminTransactionViewSet(viewsets.ViewSet):
    ...
    def list_user_transactions(self, request):
        # Get user_id, start_date, and end_date from query parameters
        ...
        # Return the transactions and the total balance
